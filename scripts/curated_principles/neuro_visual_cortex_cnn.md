...
---
Visual Cortex & CNN - 포유류 시각 피질의 계층적 특징 처리 구조에서 직접 영감을 받은 합성곱 신경망 아키텍처
...
---EN---
Visual Cortex & CNN - A convolutional neural network architecture directly inspired by the hierarchical feature processing structure of the mammalian visual cortex
