...
| daily_briefing | `daily_briefings/{date}` | 2-3 min AI briefing (KO+EN), story_count, domain_stats (highlights+categorized Top 5+Others), hot_topics (동일 풀 태그 빈도 Top 8, 포괄적 태그 블랙리스트 제외, subtag merging), trend_history (research 카테고리 기사 수 7일 추이) |
