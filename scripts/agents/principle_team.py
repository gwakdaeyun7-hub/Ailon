...
- 전문 용어 영어 병기 가능
- connectionType: direct_inspiration=논문 인용 관계, structural_analogy=사후적 유사성, mathematical_foundation=동일 수학적 도구, conceptual_borrowing=개념/용어 차용(수학적 구현은 독립적), reverse_inspiration=AI의 한계가 해당 학문의 비판을 촉발
