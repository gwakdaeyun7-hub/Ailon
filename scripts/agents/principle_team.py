...
{{
  ...
  "deepDive": {{
    ...
    "coreIntuition": "핵심 직관 — 일상 비유가 아닌 수학적/알고리즘적 직관으로 서술 (100~150자, 예: '이 알고리즘은 N차원 공간에서 손실 곡면의 기울기를 따라 가장 가파른 방향으로 이동한다')",
    "coreIntuition_en": "Core intuition — mathematical/algorithmic intuition, NOT everyday analogy (2-3 sentences, e.g., 'The algorithm traverses the loss surface in N-dimensional space along the steepest gradient')",
...
- deepDive.coreIntuition: 일상 비유 수준이 아닌 수학적/알고리즘적 직관을 제공할 것 (예: "N차원 공간에서...", "확률 분포의...")
...
11. **핵심 직관(coreIntuition)**: 수학적/알고리즘적 수준의 직관을 제공하는가? (일상 비유 수준이면 감점 — 딥다이브는 전문성이 목적)
...
14. **학술 정보 밀도**: originalProblem/bridge에 핵심 논문명·인물명·년도가 충분히 포함되어 있는가?
