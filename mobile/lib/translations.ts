...
const translations: Record<string, Record<Language, string>> = {
  ...
  'snaps.foundation': { ko: '기본원리', en: 'Foundation' },
  'snaps.application': { ko: '응용원리', en: 'Application' },
  'snaps.integration': { ko: '융합사례', en: 'Integration' },
  'snaps.history': { ko: '역사', en: 'History' },
  'snaps.deep_mechanism': { ko: '메커니즘', en: 'Mechanism' },
  'snaps.formula': { ko: '수식/공식', en: 'Formula' },
  'snaps.modern': { ko: '현대적 의의', en: 'Modern Significance' },
