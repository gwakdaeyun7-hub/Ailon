...
'.ctrl-hint{display:flex;justify-content:space-between;font-size:10px;color:var(--text3);padding:0 52px 0 48px;margin-top:-6px}' +
...
'.preset{flex:1;padding:14px 4px;border:2px solid var(--border);background:var(--surface);color:var(--text2);font-size:11px;font-weight:700;text-align:center;cursor:pointer;letter-spacing:0.3px;border-radius:8px;min-width:0;min-height:44px}' +
...
'aiConn:"\\uB1CC\\uC758 \\uC608\\uCE21 \\uCF54\\uB529 = LLM\\uC758 \\uB2E4\\uC74C \\uD1A0\\uD070 \\uC608\\uCE21. \\uC608\\uCE21 \\uC624\\uCC28 = \\uD559\\uC2B5 \\uC2E0\\uD638 (loss)",' +
...
'aiConn:"Brain\\u2019s predictive coding = LLM\\u2019s next token prediction. Prediction error = learning signal (loss)",' +
'predErrorAI:"Prediction Error (= AI Loss)"}' +
'};' +
'var T=L[LANG]||L.en;' +
