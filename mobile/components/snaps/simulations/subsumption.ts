...
'.layer-row{display:flex;align-items:center;gap:8px;margin-bottom:8px;min-height:44px;padding:6px 8px;border:2px solid var(--border);border-radius:8px;overflow:hidden}' +
