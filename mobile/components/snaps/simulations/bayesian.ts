...
'.reveal-btn{padding:14px 12px;border:2px solid var(--border);background:var(--surface);color:var(--text2);font-size:11px;font-weight:700;cursor:pointer;border-radius:8px;overflow:hidden}' +
