...
'body{font-family:-apple-system,BlinkMacSystemFont,sans-serif;background:var(--bg);color:var(--text);padding:0 6px;margin:0;-webkit-user-select:none;user-select:none}' +
...
'<div class="legend-item"><div class="legend-dot" style="background:rgba(94,234,212,0.9)"></div><span id="lgVeh"></span></div>' +
...
'<div style="display:flex;justify-content:space-between;margin:-4px 0 10px;padding:0 52px 0 48px;font-size:11px;color:var(--text3)">' +
...
'ctx.strokeStyle="rgba(94,234,212,1)";ctx.lineWidth=2;' +
