...
'.chk-row{display:flex;gap:12px;margin-bottom:10px;align-items:center}' +
'.chk-label{display:flex;align-items:center;gap:4px;font-size:12px;font-weight:700;cursor:pointer}' +
'.chk-label input{width:18px;height:18px;accent-color:var(--teal)}' +
