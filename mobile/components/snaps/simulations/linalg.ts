...
'.btn{flex:1;padding:10px 4px;border:2px solid var(--border);background:var(--surface);color:var(--text);font-size:11px;font-weight:700;text-align:center;cursor:pointer;letter-spacing:0.3px;-webkit-tap-highlight-color:transparent;min-width:54px;border-radius:8px}' +
