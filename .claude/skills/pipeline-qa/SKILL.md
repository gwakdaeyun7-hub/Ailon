...
2. **부자연스러운 경우 (사실 전달에 '...' 강제 부착):**
   - 명확한 사실 발표: "~공개...", "~출시...", "~발표...", "~도입..." (공개/출시/발표/인수/도입 자체가 확정 사실이면 '...' 불필요)
...
| 부자연스러운 '...' 반복 패턴 | LLM이 '확정 사실(공개/출시/도입) 뒤 ...로 부가정보 연결' 패턴 반복 | 프롬프트에 구체적 ❌/✅ 예시 추가 — '공개/출시/발표/인수/도입' 뒤 '...' 절대 금지, 쉼표(,)로 연결 (2026-03-15 강화) |
