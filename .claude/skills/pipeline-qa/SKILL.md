...
| **난이도 적절성** | 수식 설명에 중간 단계 포함, 전문 용어는 풀어쓴 설명 먼저 + 용어명 나중에, 구체적 사례(TSP 등) 포함, 공간적 비유(산악 지형 등) 활용 | 지수함수 극한을 독자가 직접 추론해야 함, 전문 용어 불쑥 등장, 한 문장에 3개념+ 과밀, 이론 수치(c/ln(1+t) 등) 과다 | Major |
