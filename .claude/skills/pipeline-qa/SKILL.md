...
2. **부자연스러운 경우 (확정 사실 서술어 뒤 '...'를 구분자로 사용):**
   - '주제...부가정보' 구분자 패턴: "X 공개... Y 효과", "Z 출시... W 혁신" — 확정 사실 서술어 뒤 '...'로 부가정보를 연결하는 패턴. 쉼표(,)로 연결해야 함
   - 금지 서술어 목록 (확정 사실 뒤 '...' 금지): 공개, 출시, 발표, 도입, 인수, 합류, 투자, 적용, 탑재, 시작, 달성, 수상, 기록, 확정, 체결, 선정 등
...
| 이슈 유형 | 원인 | 수정 |
|-----------|------|------|
| 부자연스러운 '...' 구분자 패턴 반복 | LLM이 '확정 사실(공개/출시/도입 등) 뒤 ...로 부가정보 연결' 패턴 반복 | 프롬프트에 금지 서술어 16개+ 명시 + 구분자 패턴 금지 + ❌/✅ 예시 추가 (2026-03-16 적용) |
