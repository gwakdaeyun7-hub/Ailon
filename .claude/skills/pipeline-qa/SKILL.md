...
```
| # | 기사 제목 | one_line | sections | why_important | 종합 |
|---|----------|----------|----------|---------------|------|
| 1 | "OpenAI, GPT-5..." | Pass — 사건 명확 | Pass — 3섹션, subtitle 구체적, 수치 포함 | Pass — 구체적 영향 | Pass |
| 2 | "Meta 감축설..." | Minor — 주어 생략 | Major — subtitle "주요 내용"(일반적), 추상적 | Pass — 구체적 | Major |
```

**판정 기준:**
- **Pass**: 말투 위반 0건 + 콘텐츠 이슈 0-1건 + sections 부족(0-1개) 0-2건
- **Minor**: 말투 위반 1-3건 또는 콘텐츠 이슈 2-3건
- **Major**: 말투 위반 4건+ 또는 콘텐츠 이슈 4건+ 또는 sections 부족 5건+
...
| 9 | 요약 품질 | Pass | 말투 위반 0건, sections 부족 0건, subtitle 구체적, 콘텐츠 이슈 없음 | 정상 |
