...
**수정 대상 파일:** `scripts/agents/news_team.py`
- `_RANK_PROMPT` (line ~1385): 랭킹 기준 프롬프트
- `_rank_category()` (line ~1408): token_budget, ctx_len 임계값
- 컨텍스트 축소 기준: line ~1421-1426
- token_budget: line ~1445
...
| 학문스낵 JSON 파싱 | principle_team.py | `_safe_json_parse()` (Phase 1 즉시 파싱 + Phase 2 폴백) | ~76-208 |
...
#### 랭킹 판정
| 카테고리 | Top 1 기사 | 적절성 | 근거 |
|----------|-----------|--------|------|
| research | "새 벤치마크 논문" | 적절 | 주요 벤치마크 |
